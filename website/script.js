...
document.getElementById('joinDiscordBtn').addEventListener('click', () => {
    window.open('https://discord.gg/BcbUXeA5Wq', '_blank');
    ...
    document.getElementById('modalText').textContent = 'To further access Arise feature more freely, you will need to generate a key.';
